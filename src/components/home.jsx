  ...
  return (
    <div id="home" className="min-h-screen bg-gradient-to-br from-gray-950 via-black to-gray-950 text-gray-100 font-sans overflow-x-hidden relative">
        ...
        >
          ...
          <div className="mb-6 sm:mb-8 px-2 sm:px-4 relative">
            ...
            <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold mb-3 sm:mb-4 tracking-tight">
              <span className="block mb-1 sm:mb-2 text-gray-400 font-light text-base sm:text-lg md:text-xl">HELLO, I'M</span>
            ...
            <div className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-300 font-mono tracking-wider mt-3 sm:mt-4">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-3 sm:gap-4 lg:gap-5 px-2 sm:px-4">
            <a 
              href="#projects" 
              className="group relative px-6 sm:px-8 py-3 sm:py-4 bg-gradient-to-r from-cyan-600 via-purple-600 to-pink-600 text-white font-bold rounded-lg sm:rounded-xl hover:shadow-xl sm:hover:shadow-2xl hover:shadow-cyan-500/30 transition-all duration-500 transform hover:-translate-y-1 flex items-center justify-center gap-2 sm:gap-3 text-xs sm:text-sm md:text-base tracking-wider overflow-hidden"
            >
            ...
            <button 
              ...
              className="group relative px-6 sm:px-8 py-3 sm:py-4 bg-gradient-to-r from-gray-900/80 to-black/80 backdrop-blur-sm border border-cyan-500/30 text-gray-300 font-bold rounded-lg sm:rounded-xl hover:border-purple-500/50 hover:shadow-xl sm:hover:shadow-2xl hover:shadow-purple-500/20 transition-all duration-500 flex items-center justify-center gap-2 sm:gap-3 text-xs sm:text-sm md:text-base tracking-wider overflow-hidden"
            >
        ...
        >
          ...
          <div className="bg-gradient-to-br from-gray-900/40 via-black/40 to-gray-900/40 backdrop-blur-2xl rounded-2xl sm:rounded-3xl p-6 sm:p-8 md:p-12 border border-cyan-500/20 shadow-xl sm:shadow-2xl shadow-cyan-500/10 relative overflow-hidden">
            ...
            <div className="flex items-center mb-8 sm:mb-12">
              <div className="relative">
                <div className="w-10 h-10 sm:w-12 sm:h-12 md:w-14 md:h-14 rounded-xl sm:rounded-2xl bg-gradient-to-br from-cyan-500 to-purple-600 flex items-center justify-center shadow-lg shadow-cyan-500/30">
              ...
              <h2 className="ml-4 sm:ml-6 text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-bold text-white tracking-tight">
                ...
                <div className="grid grid-cols-3 gap-4 sm:gap-6 pt-6 sm:pt-8">
                  {[
                    ...
                    <div key={idx} className="text-center group">
                      <div className={`relative w-10 h-10 sm:w-12 sm:h-12 md:w-14 md:h-14 lg:w-16 lg:h-16 rounded-lg sm:rounded-xl md:rounded-2xl bg-gradient-to-br ${stat.color} mx-auto mb-2 sm:mb-3 flex items-center justify-center group-hover:scale-110 transition-transform duration-300`}>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                  {skills.map((skill, idx) => (
                    <div key={idx} className="group relative">
                      <div className={`p-3 sm:p-4 rounded-xl sm:rounded-2xl bg-gradient-to-br ${skill.color} border border-white/10 hover:border-white/30 transition-all duration-500 group-hover:scale-[1.02] group-hover:shadow-lg sm:group-hover:shadow-xl group-hover:shadow-purple-500/20`}>
        ...
        <section id="projects" className="mb-20 sm:mb-32 scroll-mt-20">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="text-center mb-12 sm:mb-16">
              ...
              <p className="text-gray-400 max-w-2xl mx-auto text-xs sm:text-sm md:text-base lg:text-lg font-light px-2">
                  ...
                  <div className="relative">
                    ...
                    {project.img ? (
                      ...
                      <div className="flex gap-3 sm:gap-4 overflow-x-auto scroll-smooth mb-4 sm:mb-6 pb-2">
                        {project.imgs.map((img, i) => (
                          <div key={i} className="relative rounded-lg sm:rounded-xl md:rounded-2xl overflow-hidden border border-gray-700/50 group-hover:border-cyan-500/30 transition-all duration-500 flex-shrink-0">
                            <img
                              src={img}
                    ...
                    <div className="flex flex-wrap gap-1.5 sm:gap-2 mb-4 sm:mb-6">
                      {project.tech.map((tech, techIdx) => (
                        <span
                          key={techIdx}
                          className="px-2 sm:px-3 py-1 sm:py-1.5 bg-gradient-to-r from-gray-800/70 to-black/70 text-gray-300 text-xs rounded-lg border border-cyan-500/20 group-hover:border-purple-500/30 group-hover:text-cyan-300 group-hover:bg-gray-800/80 transition-all duration-300 tracking-wider font-mono"
                        >
                          {tech}
                        </span>
                      ))}
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 rounded-md sm:rounded-lg bg-gradient-to-br from-gray-800/70 to-black/70 border border-cyan-500/20 flex items-center justify-center group-hover:border-purple-500/30 group-hover:bg-gray-800/80 group-hover:rotate-90 transition-all duration-500">
                        <FaExternalLinkAlt className="text-gray-400 group-hover:text-cyan-300 text-xs sm:text-xs" />
                      </div>
                    </div>
                  </div>
            ...
            <div className="max-w-7xl mx-auto px-2 sm:px-0">
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
                {[
                  ...
                  <div
                    key={index}
                    className="group relative rounded-xl sm:rounded-2xl md:rounded-3xl border border-cyan-500/20 bg-gradient-to-br from-gray-900/50 via-black/50 to-gray-900/50 backdrop-blur-xl p-3 sm:p-4 md:p-5 shadow-lg sm:shadow-xl transition-all duration-700 cursor-pointer hover:scale-[1.03] hover:border-cyan-500/40 hover:shadow-xl sm:hover:shadow-2xl hover:shadow-cyan-500/10"
                    onClick={() => {
                  ...
                  >
                    ...
                    <div className="relative text-center px-1">
                      ...
                      <p className="text-xs sm:text-sm text-gray-400 mb-2 sm:mb-3">{cert.subtitle}</p>
                ...
                {[
                  ...
                  >
                    ...
                    <div className="relative text-center px-1">
                      ...
                      <p className="text-xs sm:text-sm text-gray-400 mb-2 sm:mb-3">{webinar.subtitle}</p>
                      <div className="text-xs text-cyan-400 tracking-widest font-mono group-hover:tracking-wider transition-all duration-300">
                        CLICK TO VIEW
                      </div>
                    </div>
                ...
                <div>
                  ...
                  <div className="space-y-3 sm:space-y-4 md:space-y-5">
                    {[
                      ...
                      <div
                        key={idx}
                        className="group flex items-center gap-3 sm:gap-4 p-3 sm:p-4 md:p-5 rounded-lg sm:rounded-xl md:rounded-2xl bg-gradient-to-r from-gray-900/50 to-black/50 border border-cyan-500/20 hover:border-purple-500/30 transition-all duration-500 hover:scale-[1.02]"
                      >
                        <div className={`w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 rounded-lg sm:rounded-xl bg-gradient-to-br ${info.color} flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform duration-500`}>
                    ...
                    <div className="flex flex-wrap gap-2 sm:gap-3">
                      {socialLinks.map((link, idx) => (
                        <a
                          ...
                          target="_blank"
                          rel="noreferrer"
                          className={`w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 rounded-lg sm:rounded-xl bg-gradient-to-br ${link.color} border border-gray-700 flex items-center justify-center transition-all duration-500 hover:scale-110 sm:hover:scale-125 hover:shadow-lg sm:hover:shadow-2xl hover:shadow-cyan-500/30`}
                  ...
                  <form className="space-y-3 sm:space-y-4 md:space-y-5">
                    <div className="relative">
                      <input
                        ...
                        className="w-full p-3 sm:p-4 rounded-lg sm:rounded-xl md:rounded-2xl bg-gradient-to-r from-gray-900/50 to-black/50 border border-cyan-500/20 text-white placeholder-gray-500 focus:outline-none focus:border-purple-500/50 focus:ring-2 focus:ring-purple-500/20 transition-all duration-300 text-xs sm:text-sm tracking-wider font-mono"
                      />
                    ...
                    <div className="relative">
                      <textarea
                        ...
                        rows="4"
                        className="w-full p-3 sm:p-4 rounded-lg sm:rounded-xl md:rounded-2xl bg-gradient-to-r from-gray-900/50 to-black/50 border border-cyan-500/20 text-white placeholder-gray-500 focus:outline-none focus:border-purple-500/50 focus:ring-2 focus:ring-purple-500/20 transition-all duration-300 resize-none text-xs sm:text-sm tracking-wider font-mono"
                      ></textarea>
                    ...
                    <button
                      ...
                      className="w-full py-3 sm:py-4 bg-gradient-to-r from-cyan-600 via-purple-600 to-pink-600 text-white font-bold rounded-lg sm:rounded-xl md:rounded-2xl hover:shadow-lg sm:hover:shadow-2xl hover:shadow-cyan-500/30 transition-all duration-500 transform hover:-translate-y-1 flex items-center justify-center gap-2 sm:gap-3 text-xs sm:text-sm md:text-base tracking-wider"
                    >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <div className="inline-flex items-center gap-2 sm:gap-3 mb-4 sm:mb-6">
              <div className="w-8 h-8 sm:w-9 sm:h-9 md:w-10 md:h-10 rounded-lg sm:rounded-xl bg-gradient-to-br from-cyan-500/20 to-purple-500/20 border border-cyan-500/30 flex items-center justify-center">
                <FaCode className="text-cyan-400 text-sm sm:text-base" />
              </div>
      ...
      <Dialog
        ...
        className="bg-gradient-to-br from-gray-900/90 via-black/90 to-gray-900/90 border border-cyan-500/20 backdrop-blur-2xl max-w-[95vw] sm:max-w-lg md:max-w-xl"
      >
        <div className="flex flex-col items-center gap-4 sm:gap-6 md:gap-8">
          <div className="relative">
            ...
            <img
              src={profileImageUrl}
              alt="Rossellah Marie Bodaño"
              className="relative w-24 h-24 sm:w-32 sm:h-32 md:w-40 md:h-40 lg:w-48 lg:h-48 rounded-full border-4 border-black shadow-2xl object-cover"
              onError={handleImageError}
            />
          </div>
      ...
      >
        {selectedCert && (
          <div className="flex flex-col items-center gap-4 sm:gap-6 md:gap-8">
            <div className="relative rounded-lg sm:rounded-xl md:rounded-2xl overflow-hidden border border-cyan-500/30">
              <img
                src={selectedCert}
                alt="Certificate"
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 w-full px-2">
              ...
              <button
                ...
                className="px-4 sm:px-6 py-2 sm:py-3 bg-gradient-to-r from-gray-800/70 to-black/70 text-gray-300 font-bold rounded-lg sm:rounded-xl hover:shadow-lg sm:hover:shadow-2xl hover:shadow-purple-500/20 transition-all duration-300 flex items-center justify-center gap-2 sm:gap-3 text-xs sm:text-sm tracking-wider hover:scale-105 flex-1"
              >
                CLOSE
              </button>
            </div>
      ...
      >
        <div className="space-y-4 sm:space-y-6">
          ...
          <div className="pt-4 sm:pt-6 border-t border-cyan-500/20">
            <h4 className="text-white font-bold mb-3 sm:mb-4 text-base sm:text-lg tracking-wider flex items-center gap-2">
              <FaMagic className="text-purple-400 text-sm sm:text-base" />
              MY PRINCIPLES:
            </h4>
            <ul className="text-gray-300 space-y-2 sm:space-y-3 text-xs sm:text-sm md:text-base">
              {[
